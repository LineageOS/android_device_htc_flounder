...
{
    sysfs_write(TIMER_RATE_PATH, "20000");
    sysfs_write(TIMER_SLACK_PATH, "20000");
    sysfs_write(MIN_SAMPLE_PATH, "80000");
    sysfs_write(HISPEED_FREQ_PATH, "1530000");
    sysfs_write(GO_HISPEED_LOAD_PATH, "99");
    sysfs_write(TARGET_LOADS_PATH, "65 228000:75 624000:85");
    sysfs_write(ABOVE_HISPEED_DELAY_PATH, "20000");
    sysfs_write(BOOSTPULSE_DURATION_PATH, "1000000");
    sysfs_write(IO_IS_BUSY_PATH, "0");
