...
#define CPU_TEMP_NUM            3
#define BATTERY_TEMP_NUM        2
#define GPU_TEMP_NUM            4
...
static ssize_t get_cpu_temperatures(struct hardware_properties_module *module,
    ...
    *temps = malloc(CPU_NUM * sizeof(float));
    ...
    sprintf(file_name, TEMPERATURE_FILE_FORMAT, CPU_TEMP_NUM);
...
struct hardware_properties_module HAL_MODULE_INFO_SYM = {
    .common = {
        ...
        .name = "Flounder Hardware Properties HAL",
