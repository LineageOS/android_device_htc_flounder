...
def FullOTA_InstallEnd(info):
  try:
    ...
    info.script.AppendExtra(GetImageEdifyScript(
        input_zip, "/dev/block/platform/sdhci-tegra.3/by-name/OTA", "bootloader.img"));
  ...
  try:
    ...
    info.script.AppendExtra(GetImageEdifyScript(
        input_zip, "/dev/block/platform/sdhci-tegra.3/by-name/VNR", "vendor.img"));
